...
export default function RecommendedPlantCard(props) {
    ...
    return (
        <div className="bg-transparent w-full h-full m-auto border-2 rounded-xl shadow-2xl cursor-pointer group perspective">
            <div className="relative w-full h-full preserve-3d group-hover:my-rotate-y-180 duration-700">
                <div className="absolute backface-hidden h-80 w-full border-2 border-black">
                    <Image src={makeUrl()} alt='not loaded' layout='fill'/>
                </div>
                <div className="text-left w-full h-full m-5 my-rotate-y-180 backface-hidden bg-green-300 absolute flex flex-row">

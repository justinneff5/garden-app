...
export default function MainGrid(props) {
    ...
    if (!size) {
        ...
        for (let i = 0; i < (props.x * props.y); i++){
            gridBoxLayout.push(<GridBox i={i} size={size} garden_plants={props.garden_plants} valid={valids[i]} name={name} image_link={link} moisture={moisture} exposure={exposure}></GridBox>)
        }
    ...
    return (
        <div className="flex h-screen w-screen">
            <div className="w-[32rem] h-[36rem] mt-20 mr-2">
